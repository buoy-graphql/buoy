    ...
    render() {
        return (
            <footer className="nav-footer" id="footer">
                <section className="sitemap" style={{paddingLeft: '250px'}}>
                    <a href={this.props.config.baseUrl}>
                    {this.props.config.footerIcon && (
                        <img src={this.props.config.baseUrl + this.props.config.footerIcon}
                    ...
                    <div>
                        <h5>Documentation</h5>
                        <a href="/docs/next/getting-started/installation">
                            Getting Started
                        </a>
                        <a href="/docs/next/api-reference/query">
                            API Reference
                        </a>
                    </div>
                    <div>
                        ...
                        <a href="http://stackoverflow.com/questions/tagged/ngx-buoy"
                           target="_blank"
